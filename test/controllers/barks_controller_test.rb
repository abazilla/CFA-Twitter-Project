...
class BarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bark" do
    assert_difference('Bark.count') do
      post barks_url, params: { bark: { description: @bark.description, doggo_id: @bark.doggo_id } }
    end
  ...
  test "should update bark" do
    patch bark_url(@bark), params: { bark: { description: @bark.description, doggo_id: @bark.doggo_id } }
